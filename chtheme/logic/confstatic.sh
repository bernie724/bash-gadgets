...
xfconf-query -c xfce4-panel -p /plugins/plugin-14/appearance -n -t int -s 0 
...
xfconf-query -c xfce4-panel -p /panels/panel-1/plugin-ids -n -a -t int -s 1 -t int -s 12 -t int -s 4 -t int -s 2 -t int -s 3 -t int -s 5 -t int -s 17 -t int -s 7 -t int -s 6 -t int -s 8 -t int -s 9 -t int -s 10 -t int -s 14 -t int -s 13
