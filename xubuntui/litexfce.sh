...
xfconf-query -c xsettings -p /Net/ThemeName -n -t 'string' -s 'Greybird' 2> /dev/null
xfconf-query -c xsettings -p /Net/IconThemeName -n -t 'string' -s 'Tango' 2> /dev/null
