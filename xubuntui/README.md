#### script to install custom xfce settings and use flatpak as the main desktop apps manager on ubuntu [xubuntu mini], on xubuntu mini after the intial install run xubuntui.sh as root.
